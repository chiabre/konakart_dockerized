#----------------------------------------------------------
# KonaKart v9.4.0.1 demo database script for MySQL database
#----------------------------------------------------------
#
# Note: 
...
#---------------------------------------------------------------
# KonaKart supplementary v9.4.0.1 demo database script for MySQL database
#---------------------------------------------------------------
#
...
# Prometheus mysql_export
CREATE USER 'exporter_usr'@'%' IDENTIFIED BY 'exporter_pwd';
GRANT PROCESS, REPLICATION CLIENT ON *.* TO 'exporter_usr'@'%';
GRANT SELECT ON performance_schema.* TO 'exporter_usr'@'%';
GRANT SELECT ON konakart.* TO 'exporter_usr'@'%';