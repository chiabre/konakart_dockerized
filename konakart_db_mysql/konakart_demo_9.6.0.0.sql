#----------------------------------------------------------
# KonaKart v9.6.0.0 demo database script for MySQL database
#----------------------------------------------------------
#
# Note: 
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES                ('KonaKart new store creation SQL','KK_NEW_STORE_SQL_FILENAME','/usr/local/konakart/database/MySQL/konakart_new_store.sql','Filename containing the KonaKart new store creation SQL commands','25', '10', now());
DELETE FROM configuration WHERE configuration_key = 'USER_NEW_STORE_SQL_FILENAME';
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES                ('User new store creation SQL','USER_NEW_STORE_SQL_FILENAME','/usr/local/konakart/database/MySQL/konakart_user_new_store.sql','Filename containing the user defined new store creation SQL commands - these are executed after the KonaKart cloning commands','25', '11', now());
...
UPDATE configuration SET configuration_value = '/usr/local/konakart/database/MySQL/konakart_new_store.sql' WHERE configuration_key = 'KK_NEW_STORE_SQL_FILENAME';
UPDATE configuration SET configuration_value = '/usr/local/konakart/database/MySQL/konakart_user_new_store.sql' WHERE configuration_key = 'USER_NEW_STORE_SQL_FILENAME';
...
INSERT INTO kk_config (kk_config_key, kk_config_value, date_added) VALUES ('VERSION', '9.6.0.0 MySQL', now());
...
CREATE TABLE kk_variant_prices (
	variant_price_id INT NOT NULL auto_increment,
	products_id INT NOT NULL,
	...
	KEY i_kvp_prodid (products_id),
	KEY i_kvp_store (store_id)
);
...
# New KKAdminIf API
INSERT INTO kk_api_call (name, description, date_added) VALUES ('setProductVariantQuantityWithOptions', '', now());
