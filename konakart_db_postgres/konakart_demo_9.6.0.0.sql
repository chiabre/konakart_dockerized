...
-- Created: Tue Aug 30 17:51:13 CEST 2022
-- -----------------------------------------------------------
-- 
...
-----------------------------------------------------------------
-- KonaKart supplementary v9.6.0.0 demo database script for MySQL database
-----------------------------------------------------------------
--
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES                ('Image base path','IMG_BASE_PATH','/usr/local/konakart/webapps/konakart/images','The base path where application images are saved','4', '10', now());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES                ('Report definitions base path','REPORTS_DEFN_PATH','/usr/local/konakart/webapps/birt-viewer/reports/','The reports definition location','17', '1', now());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('KonaKart Log file Directory', 'KONAKART_LOG_FILE_DIRECTORY', '/usr/local/konakart/logs', 'The location where KonaKart will write diagnostic log files', '20', '2', now());
...
UPDATE configuration SET configuration_value = '/usr/local/konakart/webapps/birtviewer/reports/' WHERE configuration_key = 'REPORTS_DEFN_PATH';
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES                ('KonaKart new store creation SQL','KK_NEW_STORE_SQL_FILENAME','/usr/local/konakart/database/PostgreSQL/konakart_new_store.sql','Filename containing the KonaKart new store creation SQL commands','25', '10', now());
DELETE FROM configuration WHERE configuration_key = 'USER_NEW_STORE_SQL_FILENAME';
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES                ('User new store creation SQL','USER_NEW_STORE_SQL_FILENAME','/usr/local/konakart/database/PostgreSQL/konakart_user_new_store.sql','Filename containing the user defined new store creation SQL commands - these are executed after the KonaKart cloning commands','25', '11', now());
...
UPDATE configuration SET configuration_value = '/usr/local/konakart/webapps/birtviewer/reports/stores/store1/' WHERE configuration_key = 'REPORTS_DEFN_PATH';
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('KonaKart Installation Home', 'INSTALLATION_HOME','/usr/local/konakart/','The home directory of this KonaKart Installation', '1', '26', now());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('PDF Directory', 'PDF_BASE_DIRECTORY', '/usr/local/konakart/pdf/', 'Defines the root directory for the location of the PDF documents that are created', '27', '5', now());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Exported Orders Directory', 'EXPORT_ORDERS_BASE_DIRECTORY', '/usr/local/konakart/orders', 'Defines the root directory where the Orders are exported to', '7', '7', now());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Sitemap file Directory', 'SITEMAP_FILE_DIRECTORY', '/usr/local/konakart/batchlogs/', 'The location where KonaKart will write sitemap files', '30', '1', now());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Import files path','IMPORT_FILES_PATH','/usr/local/konakart/data/','The import data files location',29,50,now());

-- Importer Log file location
DELETE FROM configuration WHERE configuration_key = 'IMPORTER_LOG_FILE_DIRECTORY';
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Importer Log file Directory', 'IMPORTER_LOG_FILE_DIRECTORY', '/usr/local/konakart/importerlogs/', 'The location where KonaKart will write importer log files', 29, 60, now());
...
UPDATE configuration SET configuration_value = '/usr/local/konakart/webapps/birtviewer/reports/stores/store1/' WHERE configuration_key = 'REPORTS_DEFN_PATH';
UPDATE configuration SET configuration_value = '/usr/local/konakart/webapps/konakart/images' WHERE configuration_key = 'IMG_BASE_PATH';
UPDATE configuration SET configuration_value = '/usr/local/konakart/conf/konakart_mail.properties' WHERE configuration_key = 'KONAKART_MAIL_PROPERTIES_FILE';
UPDATE configuration SET configuration_value = '/usr/local/konakart/logs' WHERE configuration_key = 'KONAKART_LOG_FILE_DIRECTORY';
UPDATE configuration SET configuration_value = '/usr/local/konakart/database/PostgreSQL/konakart_new_store.sql' WHERE configuration_key = 'KK_NEW_STORE_SQL_FILENAME';
UPDATE configuration SET configuration_value = '/usr/local/konakart/database/PostgreSQL/konakart_user_new_store.sql' WHERE configuration_key = 'USER_NEW_STORE_SQL_FILENAME';
UPDATE configuration SET configuration_value = '/usr/local/konakart/' WHERE configuration_key = 'INSTALLATION_HOME';
UPDATE configuration SET configuration_value = '/usr/local/konakart/pdf/' WHERE configuration_key = 'PDF_BASE_DIRECTORY';
UPDATE configuration SET configuration_value = '/usr/local/konakart/templates/' WHERE configuration_key = 'TEMPLATE_BASE_DIRECTORY';
UPDATE configuration SET configuration_value = '/usr/local/konakart/orders' WHERE configuration_key = 'EXPORT_ORDERS_BASE_DIRECTORY';
UPDATE configuration SET configuration_value = '/usr/local/konakart/batchlogs/' WHERE configuration_key = 'BATCH_LOG_FILE_DIRECTORY';
UPDATE configuration SET configuration_value = '/usr/local/konakart/batchlogs/' WHERE configuration_key = 'SITEMAP_FILE_DIRECTORY';
UPDATE configuration SET configuration_value = '/usr/local/konakart/importerlogs/' WHERE configuration_key = 'IMPORTER_LOG_FILE_DIRECTORY';
UPDATE configuration SET configuration_value = '/usr/local/konakart/data/' WHERE configuration_key = 'IMPORT_FILES_PATH';
...
CREATE TABLE kk_product_prices (
  ...
  products_options VARCHAR(128) DEFAULT '-' NOT NULL,
  variant_code VARCHAR(128) DEFAULT '-',
  products_price_0 DECIMAL(15,4),
  products_price_1 DECIMAL(15,4),
  products_price_2 DECIMAL(15,4),
  products_price_3 DECIMAL(15,4),
  PRIMARY KEY (catalog_id, products_id, products_attributes_id, tier_price_id, products_options)
);
...
UPDATE configuration SET configuration_value = '/usr/local/konakart/digitalDownload' WHERE configuration_key = 'DD_BASE_PATH';
...
INSERT INTO kk_config (kk_config_key, kk_config_value, date_added) VALUES ('HISTORY', '9.6.0.0 I', now());
INSERT INTO kk_config (kk_config_key, kk_config_value, date_added) VALUES ('VERSION', '9.6.0.0 PostgreSQL', now());

-- Custom fields for categories_description
ALTER TABLE categories_description ADD COLUMN customd1 varchar(16);
ALTER TABLE categories_description ADD COLUMN customd2 varchar(16);
ALTER TABLE categories_description ADD COLUMN customd3 varchar(16);
ALTER TABLE categories_description ADD COLUMN customd4 varchar(16);
ALTER TABLE categories_description ADD COLUMN customd5 varchar(16);

-- Table for variant prices
DROP TABLE IF EXISTS kk_variant_prices;
CREATE TABLE kk_variant_prices (
	variant_price_id SERIAL,
	products_id INTEGER NOT NULL,
	products_options VARCHAR(128) DEFAULT '-',
	variant_code VARCHAR(128) DEFAULT '-',
	price_0 DECIMAL(15,4),
	price_1 DECIMAL(15,4),
	price_2 DECIMAL(15,4),
	...
	last_modified TIMESTAMP,
	store_id VARCHAR(64),
	PRIMARY KEY (variant_price_id)
);
CREATE INDEX i_kvp_prodid ON kk_variant_prices (products_id);
CREATE INDEX i_kvp_store ON kk_variant_prices (store_id);

-- New configuration variable to be used to determine the variant price handling mode
DELETE FROM configuration WHERE configuration_key = 'VARIANT_HANDLING_MODE';
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, return_by_api) VALUES ('Variant Handling Mode', 'VARIANT_HANDLING_MODE', 'DEFAULT', 'Variant price handling mode', 32, 1, 'choice(''DEFAULT''=''DEFAULT'',''ENHANCED''=''ENHANCED'')', now(), 1);

-- Introduce Variant Code field to handle the variant product quantities transmission from/to MAGO
ALTER TABLE products_quantity ADD COLUMN variant_code VARCHAR(128) DEFAULT '-';

-- New KKAdminIf API
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT,'setProductVariantQuantityWithOptions', '', now());

-- Add some extra fields to the customers table
ALTER TABLE customers ADD customers_natural_person char(1);
ALTER TABLE customers ADD tax_identifier_2 varchar(64);
ALTER TABLE customers ADD customers_title varchar(10);
ALTER TABLE customers ADD customers_privacy char(1);
ALTER TABLE customers ADD customers_terms char(1);
ALTER TABLE customers ADD custom6 varchar(128);

-- Add comment to the customers basket and orders products
ALTER TABLE customers_basket ADD custom11 VARCHAR(16);
ALTER TABLE orders_products ADD custom11 VARCHAR(16);

ALTER TABLE customers ADD custom7 varchar(128);

-- New configuration variable to define barcode type, used in email templates
DELETE FROM configuration WHERE configuration_key = 'EMAIL_BARCODE_TYPE';
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, return_by_api) VALUES ('Email barcode type', 'EMAIL_BARCODE_TYPE', 'NONE', 'Email barcode type to generate', 12, 8, 'option(NONE=NONE,CODE_39=CODE_39,QR_CODE=QR_CODE,AZTEC=AZTEC)', now(), 1);

-- Used to enable barcode generation for order confirmation email
DELETE FROM configuration WHERE configuration_key = 'ORDER_CONF_EMAIL_WITH_BARCODE';
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, return_by_api) VALUES ('Enable barcode generation for order confirmation email','ORDER_CONF_EMAIL_WITH_BARCODE','false','When true, a customer receives an eMail with a barcode to scan', 12, 8, 'choice(''true''=''true'',''false''=''false'')', now(), '1');

-- Add some extra fields to the manufacturers table
ALTER TABLE manufacturers ADD custom11 varchar(128);
ALTER TABLE manufacturers ADD custom12 varchar(128);

-- PAYMENT_REQUEST_PROXY
DELETE FROM configuration WHERE configuration_key = 'PAYMENT_REQUEST_PROXY_HOST';
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, return_by_api) VALUES ('Payment Request Proxy','PAYMENT_REQUEST_PROXY_HOST','0','KonaKart will send payment requests over proxy to payment provider (host:port)',31,166,now(),'1');

-- C26124W: WOND / KonaKart Limiting Items in order
ALTER TABLE products ADD min_quantity_in_order INT;
ALTER TABLE products ADD max_quantity_in_order INT;
ALTER TABLE products ADD default_quantity_in_order INT;

ALTER TABLE customers ADD custom8 varchar(128);

-- C28296W:KonaKart - lock items (sold out)
ALTER TABLE products ADD custom11 varchar(128);
